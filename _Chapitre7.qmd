...
## Changer le type de plusieurs variables
...
## Sélectionner la première colonne non manquante d'une liste de colonnes (fonction `coalesce()`)
...
## Créer des colonnes à partir de chaînes de caractères
