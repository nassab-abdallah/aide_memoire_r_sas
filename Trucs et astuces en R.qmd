...
# Fonction pour coller (par exemple dans Excel) des données copiées dans le presse-papier

Pour coller des données de R dans Excel, on peut :

- faire passer la fonction CopierColler ci-dessous sur les données `R` que l'on souhaite copier dans Excel
- coller le presse-papier dans Excel.
