...
La fonction suivante renvoie un NA si la fonction log() ne peut pas être appliquée, comme c'est le cas sur l'exemple pour la valeur "a".
...
-   faire passer la fonction `R` CopierColler() ci-dessous sur les données `R` que l'on souhaite copier dans Excel ;
